...
const DropDownMenu=({className,children,show,onItemClick=f=>f})=>(
  <div className={className}>
    {children}
    {show?(
      <StyledDiv>
      <div><StyledLink to="/" onClick={onItemClick}>HOME</StyledLink></div>
      <div><StyledLink to="/her" onClick={onItemClick}>FOR HER</StyledLink></div>
      <div><StyledLink to="/him" onClick={onItemClick}>FOR HIM</StyledLink></div>
      <div><StyledLink to="/comments" onClick={onItemClick}>COMMENTS</StyledLink></div>
      <div><StyledLink to="/retailer" onClick={onItemClick}>RETAILER ACCOUNT</StyledLink></div>
      <div><StyledLink to="/" onClick={onItemClick}>SHOPPING LIST</StyledLink></div>
      <div><StyledLink to="/" onClick={onItemClick}>LANGUAGE</StyledLink></div>
      <div>  <StyledLink to="/about" onClick={onItemClick}>ABOUT US</StyledLink></div>
        <div><StyledLink to="/contact" onClick={onItemClick}>CONTACT US</StyledLink></div>
      </StyledDiv>
    ):(<div></div>)}
  </div>
);
...
class App extends Component{
  ...
  render(){
    return(
      ...
      <MainDiv>
        <StyledTopBar/>
        <StyledDropDownMenu show={this.state.show} onItemClick={()=>this.setState({show:false})}>
        <div>
